...
std::optional<std::pair<double, uint64_t>> sort_by_energy(std::vector<charge_distribution_surface<Lyt>> cls)
{
    auto comp = [](charge_distribution_surface<Lyt>& cl1, charge_distribution_surface<Lyt>& cl2) { return cl1.get_system_energy() < cl2.get_system_energy(); };
...
TEMPLATE_TEST_CASE("ExGS simulation of a Bestagon wire (base 2)", "[ExGS]", (cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>))
{
...
TEMPLATE_TEST_CASE("ExGS simulation of a Bestagon wire (base 3)", "[ExGS]", (cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>))
{
    using hex_gate_lyt = hex_odd_row_gate_clk_lyt;
...
TEMPLATE_TEST_CASE("ExGS simulation of two Bestagon wires", "[ExGS]", (cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>))
{
    using hex_gate_lyt = hex_odd_row_gate_clk_lyt;
...
TEMPLATE_TEST_CASE("ExGS simulation of a Bestagon OR-gate (base 2)", "[ExGS]", (cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>))
{
    using hex_gate_lyt = hex_odd_row_gate_clk_lyt;
...
TEMPLATE_TEST_CASE("ExGS simulation of a Bestagon OR-gate (base 3)", "[ExGS]", (cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>))
{
    using hex_gate_lyt = hex_odd_row_gate_clk_lyt;
