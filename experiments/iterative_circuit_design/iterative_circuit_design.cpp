...
#include <fiction/algorithms/physical_design/iterative_circuit_design.hpp>
...
int main()  // NOLINT
{
    ...
    constexpr const uint64_t bench_select = fiction_experiments::mux21;
    ...
    for (const auto& benchmark : fiction_experiments::all_benchmarks(bench_select))
    {
        ...
        fiction::iterative_circuit_design_params<cell_lyt> params{};
        ...
        fiction::iterative_circuit_design_stats<gate_lyt> st{};

        const auto result = fiction::iterative_circuit_design<decltype(mapped_network), cell_lyt, gate_lyt>(
